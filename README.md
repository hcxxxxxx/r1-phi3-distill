...
<p align="center">
<img src="./logs/log5/loss_curve.png" alt="loss_curve" width="250">
...
<p align="center"><em>LoRA(r=4, lora_alpha=8, lora_dropout=0.1), lr_scheduler_type="cosine_with_restarts"</em></p>
