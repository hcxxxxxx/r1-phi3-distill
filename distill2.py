...
dataset = load_dataset(config["dataset"]["name"], split=config["dataset"]["split"], cache_dir="./Hcx2")
dataset = dataset.shuffle(seed=config["dataset"]["seed"])
if "num_samples" in config["dataset"]:
    dataset = dataset.select(range(config["dataset"]["num_samples"]))

# Load tokenizers
teacher_tokenizer = AutoTokenizer.from_pretrained(config["models"]["teacher"], cache_dir="./Hcx2")
student_tokenizer = AutoTokenizer.from_pretrained(config["models"]["student"], cache_dir="./Hcx2")
...
teacher_model = AutoModelForCausalLM.from_pretrained(config["models"]["teacher"], **model_kwargs, cache_dir="./Hcx2")
student_model = AutoModelForCausalLM.from_pretrained(config["models"]["student"], **model_kwargs, cache_dir="./Hcx2")
